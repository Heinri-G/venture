...
interface SavedPlaceDetailsBodyProps {
...
export function SavedPlaceDetailsBody({
  place,
  onUpdate,
  onRequestDelete,
  onViewOnMap,
  userLocation,
}: SavedPlaceDetailsBodyProps) {
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-4 pt-3">
        ...
        <div className="mt-4 flex items-start justify-between gap-3">
          <div className="min-w-0">
            <h2 className="font-heading text-xl font-medium text-foreground">{place.place.name}</h2>
            {place.place.address && (
...
export default function SavedPlaceDetails({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={handleOpenChange}>
      ...
      >
        <div className="max-h-[88dvh] overflow-hidden rounded-t-2xl">
