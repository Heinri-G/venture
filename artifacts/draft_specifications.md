# App Specification: Wanderlust Companion (Working Title)
...
* **Maps Integration**: **Mapbox GL JS** or **Leaflet** (with OpenStreetMap)
  * *Why*: Mapbox offers highly customizable, premium-feeling maps. Leaflet is a robust, free, open-source alternative.
...
2. **Location Data Source**: When adding a place, should the app pull in existing data (address, photos, hours) from a service like the Foursquare Places API/Mapbox Search, or is it purely manual entry with a pin drop?
